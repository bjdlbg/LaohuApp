package com.example.a84640.laohuapp.tools;
...
//		String[] words = {"fornow", "canine", "inaction", "noes", "heart-broken"};
//		String[] words = {"apple", "people", "art", "interesting", "dragon", "binary", "hospital", "KobeBrant", "logical"};
